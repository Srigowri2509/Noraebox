...
export default function SongCard({ song = {}, onQueue }) {
  return (
    <div 
      ...
      className="flex items-center gap-4 p-4 rounded-lg bg-slate-800/60 border-2 border-slate-500 hover:bg-slate-700/60 transition-all cursor-pointer hover:border-slate-400 mb-3"
    >
